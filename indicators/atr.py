...
def analyze_waves_atr(
    ...
    Args:
        candles: NormalizedCandles объект
        num_waves: Количество волн для анализа (default 5)
    ...
    try:
        ...
        # ============================================================
        swing_highs = _find_swing_points(highs, 'high', window=3)
        swing_lows = _find_swing_points(lows, 'low', window=3)
        ...
        # 5. РАННИЙ ВХОД?
        # ============================================================
        is_early_entry = current_wave_progress < 30
        ...
        if is_early_entry:
            adjustment += 20
        elif current_wave_progress < 50:
            adjustment += 15
        elif current_wave_progress < 70:
            adjustment += 5
        else:
            # Слишком поздно
            adjustment -= 10
...
def _find_swing_points(
    ...
    Args:
        ...
        window: Окно для проверки локального экстремума
